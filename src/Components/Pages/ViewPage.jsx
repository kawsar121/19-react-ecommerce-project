    ...
    <div className="flex gap-24 justify-center my-32">
      ...
      <div>
        ...
        <div className=" mt-4 items-center flex gap-2">
          ...
          <button className="bg-red-600 text-sm font-bold text-white px-2 rounded-sm">$0 SAVE</button>
          <p className="text-xs">(TAX INCLUDED)</p>
        </div>
        <div className="mt-6 flex gap-3">
            <button className="bg-orange-300 px-8 py-3">Buy Now</button>
            <button className="bg-blue-300 px-8 py-3">Add to Cart</button>
        </div>
      </div>
    </div>
  );
