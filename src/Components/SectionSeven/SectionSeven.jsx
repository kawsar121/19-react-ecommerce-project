      ...
      <div className="grid  lg:flex gap-2 lg:gap-28 mb-5">
        ...
        <div>
          <ul className="grid justify-center">
            <li className="mb-3 hover:border-blue-600 hover:border-b-2 pb-2 hover:font-medium">
            ...
            <li>
              <Link className=" hover:border-blue-600 hover:border-b-2 pb-2 hover:font-medium ">
                Men fashion ss
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 ">
            ...
            <div className="max-w-xs hover:shadow-lg text-white rounded-xl relative group p-4 w-52">
              ...
              <div className="absolute top-3 right-[0px] flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition duration-300">
