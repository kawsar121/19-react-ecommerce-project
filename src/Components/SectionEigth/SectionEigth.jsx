...
const SectionEigth = () => {
    return (
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 ">
        {/* First */}
        <div className="max-w-xs hover:shadow-lg mb-4 text-white rounded-xl relative group p-4 w-52">
          ...
          <div className="absolute top-7 right-[20px] flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition duration-300">
          ...
          <div className="text-center text-black hover:text-blue-700 font-semibold truncate">
            Yuzu Fast Charger
          </div>
